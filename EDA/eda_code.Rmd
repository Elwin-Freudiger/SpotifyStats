...
# Load the datasets
ambre <- read_csv(here::here("Stream_hist_ambre.csv"))
arnaud <- read_csv(here::here("Stream_hist_arnaud.csv"))
elwin <- read_csv(here::here("data/timeserie/Stream_hist_elwin.csv"))
fanny <- read_csv(here::here("data/timeserie/Stream_hist_fan.csv"))
olivier <- read_csv(here::here("data/timeserie/Stream_hist_oli.csv"))
