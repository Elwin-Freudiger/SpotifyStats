...
df_ambre <- read.csv(here::here("artist_info_ambre.csv"))
df_arnaud <- read.csv(here::here("artist_info_arnaud.csv"))
df_elwin <- read.csv(here::here("artist_info_elwin.csv"))
df_fan <- read.csv(here::here("artist_info_fan.csv"))
df_oli <- read.csv(here::here("artist_info_oli.csv"))
...
df_oli_clean <- df_oli %>% filter(genres != "['No genres available']")
...
write.csv(artistsDB, "artists_final.csv", row.names = FALSE)
